...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BUzKmLau.mjs");
...
var manifest = {
	"a40f9973125a06c5a276c04af27db54c4dd31b9a5cecc9aa92b229eb6d8af2c8": {
		functionName: "suggestRemoteWords_createServerFn_handler",
		importer: () => import("./suggest-YcP-SeCN.mjs")
	},
	"f5a4b9aea795aa8a563c94bbc098c4c538a639e5218b45f18e18bca3adf90852": {
		functionName: "transduceConcept_createServerFn_handler",
		importer: () => import("./transduce-BobbyUhL.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BsFnfdoi.mjs").then((n) => n.t),
